...
def fgsm_attacks(model_li, eps, num_iters, loss_fn, x, clip_min=0., clip_max=1.):
    alpha = eps / num_iters
...
def main(_):
    ...
    # model_li = [inc_v3, xcep, incres_v2, res152-v2]
    ...
    for i in range(images.shape[0]):
        adv_image = fgsm_attacks(model_li, eps=16/255., num_iters=20,
