...
def fgsm_attacks_with_push_and_pull(model_fn, eps, num_iters, loss_fn, x,
...
def main(_):
    ...
    for i in range(images.shape[0]):
        adv_image = fgsm_attacks_with_push_and_pull(model, eps=16/255., num_iters=20,
                                                    loss_fn=cross_entropy, x=images[i:i+1, :, :, :],
                                                    alpha=0.007, aux_num=3)
